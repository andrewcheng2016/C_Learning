...
int main(){
    ...
    //Declare and initialize the variables
    float number1{1.12345678901234567890f};  // Size: 4bytes; Precision : 7
    double number2{1.12345678901234567890};  // Size: 8bytes; Precision : 15
    long double number3{1.12345678901234567890L}; // Size: 16bytes; Precision: 15+
    ...
    // float number4 {192400023.0f};               // Error : narrowing conversion, junk will be stored in number4

    double number4 {192400023.0};               // OK
