...
int main(){
    ...
    std::cout << "sizeof(p_number5) : " << sizeof(p_number5) << std::endl; // 8 bytes (Int*)
    std::cout << "sizeof(other_int_var) : " << sizeof(other_int_var) << std::endl; // 4 bytes (Int)
    std::cout << "sizeof(p_number6) : " << sizeof(p_number6) << std::endl; // 8 bytes (Int*)
    std::cout << "sizeof(other_int_var6) : " << sizeof(other_int_var6) << std::endl; // 4 bytes (Int)
    std::cout << "----------------------------------" << std::endl;
    ...
    //Dereferencing a pointer (Read the value stored at the address) 
    int* p_int2 {nullptr};
    int int_data {56};
    p_int2 = &int_data;
